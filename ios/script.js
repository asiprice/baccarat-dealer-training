class BaccaratGame {
    ...
    setupMobileOptimizations() {
        ...
        // Add haptic feedback for button presses (iOS only)
    ...
    showPlayerDecision() {
        ...
        // Scroll decision into view on mobile
        this.elements.playerDecision.scrollIntoView({ behavior: 'smooth', block: 'center' });
    }

    showBankerDecision() {
        this.elements.bankerDecision.classList.remove('hidden');
        // Scroll decision into view on mobile
        this.elements.bankerDecision.scrollIntoView({ behavior: 'smooth', block: 'center' });
    }
    ...
    showHandResult() {
        ...
        this.elements.handResult.scrollIntoView({ behavior: 'smooth', block: 'center' });
    ...
    showFeedback(correct, message) {
        ...
        this.elements.feedback.scrollIntoView({ behavior: 'smooth', block: 'center' });
    }
    ...
    bindEvents() {
        // Use touchstart for faster response on mobile, but with preventDefault to avoid double-firing
        ...
        addMobileEvent(this.elements.playerHitBtn, () => this.handlePlayerDecision(true));
        addMobileEvent(this.elements.playerStandBtn, () => this.handlePlayerDecision(false));
        addMobileEvent(this.elements.bankerHitBtn, () => this.handleBankerDecision(true));
        addMobileEvent(this.elements.bankerStandBtn, () => this.handleBankerDecision(false));
        
        addMobileEvent(this.elements.nextHandBtn, () => {
            this.updateDisplay();
            this.startNewHand();
        });
        
        addMobileEvent(this.elements.continueBtn, () => {
            this.elements.feedback.classList.add('hidden');
        ...
        addMobileEvent(this.elements.shuffleBtn, () => {
            this.createShoe();
        ...
        addMobileEvent(this.elements.newGameBtn, () => {
            this.createShoe();
            this.correctAnswers = 0;
            this.wrongAnswers = 0;
            this.elements.shuffleBtn.disabled = true;
        ...
        addMobileEvent(this.elements.rulesBtn, () => {
            this.elements.rulesModal.classList.remove('hidden');
        });
        
        addMobileEvent(this.elements.rulesModal.querySelector('.close'), () => {
            this.elements.rulesModal.classList.add('hidden');
        });
        
        this.elements.rulesModal.addEventListener('touchstart', (e) => {
